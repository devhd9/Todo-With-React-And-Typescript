...
import {
  addItemInTodoListHandlerFuncType,
  currentItemDataType,
  deleteItemHandlerFuncType,
  editItemFuncType,
  todoDataSaveHandlerFuncType,
  todoItemType,
  toggleItemMarkedCompletedHandlerFuncType,
} from "../../Types/Types";
import getTodoItemsToDisplay, {
  addItemInTodoList,
  removeItemFromTodoData,
  toggleItemMarkedCompleted,
} from "../../utils/todoDataCrudOperation";
import {
  getTodoDataFromLocalStorage,
  setTodoDataInLocalStorage,
...
export default function TodoDisplay() {
  ...
  const [currentItemData, setCurrentItemData] = useState<currentItemDataType>({
    id: "",
    title: "",
  });
  ...
  const todoDataSaveHandler: todoDataSaveHandlerFuncType = (
    data: todoItemType[],
  ) => {
    setTodoData(data);
  ...
  const addItemInTodoListHandler: addItemInTodoListHandlerFuncType = ({
    isNewItem,
    title,
    existingUniqueId,
  }) => {
  ...
  const toggleItemMarkedCompletedHandler: toggleItemMarkedCompletedHandlerFuncType =
    (id) => {
  ...
  return (
    <div
      className={`${styles["todo-app-box"]} ${styles["todo-app-box-width"]}`}
    >
      <AppIcon />
      <SectionSelector
      ...
      <TodoItems
        ...
        toggleItemMarkedCompletedHandler={toggleItemMarkedCompletedHandler}
      />
      <AddItem setIsAddingItem={setIsAddingItem} />
      {isAddingItem ? (
        <OverlayInputForm
          addItemInTodoListHandler={addItemInTodoListHandler}
          isNewItem={true}
        />
      ) : (
        <></>
